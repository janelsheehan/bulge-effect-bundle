...
var CustomShaderMaterial = function(_THREE$Material) {
  _inherits(CustomShaderMaterial3, _THREE$Material);
  var _super = _createSuper(CustomShaderMaterial3);
  function CustomShaderMaterial3(_ref) {
    var _this;
    ...
    _classCallCheck(this, CustomShaderMaterial3);
    var base;
  ...
  _createClass(CustomShaderMaterial3, [{
    key: "update",
  ...
  return CustomShaderMaterial3;
}(Material);

// node_modules/three-custom-shader-material/dist/three-custom-shader-material.esm.js
...
var _excluded2 = ["baseMaterial", "fragmentShader", "vertexShader", "uniforms", "cacheKey", "attach"];
var CustomShaderMaterial2 = React.forwardRef(function(_ref, ref) {
  var baseMaterial = _ref.baseMaterial, fragmentShader = _ref.fragmentShader, vertexShader = _ref.vertexShader, uniforms = _ref.uniforms, cacheKey = _ref.cacheKey, _ref$attach = _ref.attach, attach = _ref$attach === void 0 ? "material" : _ref$attach, props = _objectWithoutProperties(_ref, _excluded2);
